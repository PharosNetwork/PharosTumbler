# Contributing to MyTumbler

Thank you for your interest in contributing to the MyTumbler project! We appreciate your help in making this project better.
...
- Look through existing [Issues](<!-- TODO: Replace with your GitHub Issues URL -->) to see if there's something you'd like to work on
...
1. **Grant of Copyright License**: You hereby grant to the MyTumbler authors. and to recipients of software distributed by the MyTumbler authors. a perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable copyright license to reproduce, prepare derivative works of, publicly display, publicly perform, sublicense, and distribute Your Contributions and such derivative works.

2. **Grant of Patent License**: You hereby grant to the MyTumbler authors. and to recipients of software distributed by the MyTumbler authors. a perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable (except as stated in this section) patent license to make, have made, use, offer to sell, sell, import, and otherwise transfer the Work, where such license applies only to those patent claims licensable by You that are necessarily infringed by Your Contribution(s) alone or by combination of Your Contribution(s) with the Work to which such Contribution(s) was submitted.
...
5. **Notification of Changes**: You agree to notify the MyTumbler authors. of any facts or circumstances of which you become aware that would make these representations inaccurate in any respect.
